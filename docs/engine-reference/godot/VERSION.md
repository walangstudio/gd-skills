# Godot 4.3 — Pinned Version Reference

- **Engine version**: Godot 4.3 (latest stable 4.x)
- **Language / runtime**: GDScript 2.0 (+ C#)
- **LLM knowledge cutoff**: January 2026
- **Authoritative docs**: https://docs.godotengine.org/en/stable/
